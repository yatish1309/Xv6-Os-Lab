...
801003c4:	e8 e7 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003c9:	c7 04 24 b7 7a 10 80 	movl   $0x80107ab7,(%esp)
...
80102020:	68 9e 78 10 80       	push   $0x8010789e
...
8010302a:	e8 21 3a 00 00       	call   80106a50 <switchkvm>
  seginit();
8010302f:	e8 fc 38 00 00       	call   80106930 <seginit>
  lapicinit();
...
80103074:	e8 b7 38 00 00       	call   80106930 <seginit>
  picinit();       // disable pic
...
801041f3:	68 b7 7a 10 80       	push   $0x80107ab7
...
80104be4:	68 94 78 10 80       	push   $0x80107894
...
80104bfc:	68 93 78 10 80       	push   $0x80107893
...
80104c11:	68 87 78 10 80       	push   $0x80107887
...
80104c2f:	68 96 78 10 80       	push   $0x80107896
80104c34:	e8 57 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c39:	83 ec 0c             	sub    $0xc,%esp
80104c3c:	68 78 78 10 80       	push   $0x80107878
...
8010502d:	58                   	pop    %eax
8010502e:	5a                   	pop    %edx
8010502f:	68 94 78 10 80       	push   $0x80107894
...
80105048:	68 93 78 10 80       	push   $0x80107893
...
8010575b:	78 1b                	js     80105778 <sys_sbrk+0x38>
    return -1;
  addr = myproc()->sz;
8010575d:	e8 fe e1 ff ff       	call   80103960 <myproc>
80105762:	8b 18                	mov    (%eax),%ebx
  myproc()->sz += n;
80105764:	e8 f7 e1 ff ff       	call   80103960 <myproc>
80105769:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010576c:	01 10                	add    %edx,(%eax)
  
  //if(growproc(n) < 0)
  //  return -1;
  return addr;
}
8010576e:	89 d8                	mov    %ebx,%eax
80105770:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105773:	c9                   	leave  
80105774:	c3                   	ret    
80105775:	8d 76 00             	lea    0x0(%esi),%esi
    return -1;
80105778:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
8010577d:	eb ef                	jmp    8010576e <sys_sbrk+0x2e>
8010577f:	90                   	nop
...
801057a4:	68 60 4c 11 80       	push   $0x80114c60
801057a9:	e8 b2 ed ff ff       	call   80104560 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057ae:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057b1:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  while(ticks - ticks0 < n){
...
801057c3:	68 60 4c 11 80       	push   $0x80114c60
801057c8:	68 a0 54 11 80       	push   $0x801154a0
801057cd:	e8 4e e7 ff ff       	call   80103f20 <sleep>
  while(ticks - ticks0 < n){
801057d2:	a1 a0 54 11 80       	mov    0x801154a0,%eax
...
801057f0:	68 60 4c 11 80       	push   $0x80114c60
...
80105813:	68 60 4c 11 80       	push   $0x80114c60
...
80105838:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
8010583b:	68 60 4c 11 80       	push   $0x80114c60
80105840:	e8 1b ed ff ff       	call   80104560 <acquire>
  xticks = ticks;
80105845:	8b 1d a0 54 11 80    	mov    0x801154a0,%ebx
  release(&tickslock);
8010584b:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105852:	e8 c9 ed ff ff       	call   80104620 <release>
  return xticks;
}
...
80105890 <tvinit>:
extern int 
mappages(pde_t *pgdir, void *va, uint size, uint pa, int perm); // mappages declaration here whereas it is originally defined in vm.c
...
801058a7:	c7 04 c5 a2 4c 11 80 	movl   $0x8e000008,-0x7feeb35e(,%eax,8)
801058ae:	08 00 00 8e 
801058b2:	66 89 14 c5 a0 4c 11 	mov    %dx,-0x7feeb360(,%eax,8)
801058b9:	80 
801058ba:	c1 ea 10             	shr    $0x10,%edx
801058bd:	66 89 14 c5 a6 4c 11 	mov    %dx,-0x7feeb35a(,%eax,8)
801058c4:	80 
  for(i = 0; i < 256; i++)
...
801058d7:	c7 05 a2 4e 11 80 08 	movl   $0xef000008,0x80114ea2
801058de:	00 00 ef 
  initlock(&tickslock, "time");
801058e1:	68 d9 78 10 80       	push   $0x801078d9
801058e6:	68 60 4c 11 80       	push   $0x80114c60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801058eb:	66 a3 a0 4e 11 80    	mov    %ax,0x80114ea0
801058f1:	c1 e8 10             	shr    $0x10,%eax
801058f4:	66 a3 a6 4e 11 80    	mov    %ax,0x80114ea6
  initlock(&tickslock, "time");
...
8010591f:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105923:	b8 a0 4c 11 80       	mov    $0x80114ca0,%eax
...
80105956:	0f 84 cc 01 00 00    	je     80105b28 <trap+0x1e8>
    if(myproc()->killed)
      exit();
    return;
  }
  
  if(tf->trapno == T_PGFLT) // checking whether page fault occurs
8010595c:	83 f8 0e             	cmp    $0xe,%eax
8010595f:	0f 84 03 02 00 00    	je     80105b68 <trap+0x228>
    memset(mem, 0, PGSIZE);
  ...
  switch(tf->trapno){
80105965:	83 e8 20             	sub    $0x20,%eax
80105968:	83 f8 1f             	cmp    $0x1f,%eax
8010596b:	77 08                	ja     80105975 <trap+0x35>
8010596d:	3e ff 24 85 80 79 10 	notrack jmp *-0x7fef8680(,%eax,4)
80105974:	80 
    lapiceoi();
    break;
...
80105975:	e8 e6 df ff ff       	call   80103960 <myproc>
8010597a:	8b 7b 38             	mov    0x38(%ebx),%edi
8010597d:	85 c0                	test   %eax,%eax
8010597f:	0f 84 4d 02 00 00    	je     80105bd2 <trap+0x292>
80105985:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105989:	0f 84 43 02 00 00    	je     80105bd2 <trap+0x292>
...
8010598f:	0f 20 d1             	mov    %cr2,%ecx
80105992:	89 4d d8             	mov    %ecx,-0x28(%ebp)
...
80105995:	e8 a6 df ff ff       	call   80103940 <cpuid>
8010599a:	8b 73 30             	mov    0x30(%ebx),%esi
8010599d:	89 45 dc             	mov    %eax,-0x24(%ebp)
801059a0:	8b 43 34             	mov    0x34(%ebx),%eax
801059a3:	89 45 e4             	mov    %eax,-0x1c(%ebp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801059a6:	e8 b5 df ff ff       	call   80103960 <myproc>
801059ab:	89 45 e0             	mov    %eax,-0x20(%ebp)
801059ae:	e8 ad df ff ff       	call   80103960 <myproc>
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059b3:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801059b6:	8b 55 dc             	mov    -0x24(%ebp),%edx
801059b9:	51                   	push   %ecx
801059ba:	57                   	push   %edi
801059bb:	52                   	push   %edx
801059bc:	ff 75 e4             	pushl  -0x1c(%ebp)
801059bf:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
801059c0:	8b 75 e0             	mov    -0x20(%ebp),%esi
801059c3:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801059c6:	56                   	push   %esi
801059c7:	ff 70 10             	pushl  0x10(%eax)
801059ca:	68 3c 79 10 80       	push   $0x8010793c
801059cf:	e8 dc ac ff ff       	call   801006b0 <cprintf>
            tf->err, cpuid(), tf->eip, rcr2());
    myproc()->killed = 1;
801059d4:	83 c4 20             	add    $0x20,%esp
801059d7:	e8 84 df ff ff       	call   80103960 <myproc>
801059dc:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  }
...
801059ea:	74 1d                	je     80105a09 <trap+0xc9>
801059ec:	e8 6f df ff ff       	call   80103960 <myproc>
801059f1:	8b 50 24             	mov    0x24(%eax),%edx
801059f4:	85 d2                	test   %edx,%edx
801059f6:	74 11                	je     80105a09 <trap+0xc9>
801059f8:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801059fc:	83 e0 03             	and    $0x3,%eax
801059ff:	66 83 f8 03          	cmp    $0x3,%ax
80105a03:	0f 84 af 01 00 00    	je     80105bb8 <trap+0x278>
    exit();
...
80105a10:	74 0f                	je     80105a21 <trap+0xe1>
80105a12:	e8 49 df ff ff       	call   80103960 <myproc>
80105a17:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80105a1b:	0f 84 ef 00 00 00    	je     80105b10 <trap+0x1d0>
...
80105a28:	74 1d                	je     80105a47 <trap+0x107>
80105a2a:	e8 31 df ff ff       	call   80103960 <myproc>
80105a2f:	8b 40 24             	mov    0x24(%eax),%eax
80105a32:	85 c0                	test   %eax,%eax
80105a34:	74 11                	je     80105a47 <trap+0x107>
80105a36:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a3a:	83 e0 03             	and    $0x3,%eax
80105a3d:	66 83 f8 03          	cmp    $0x3,%ax
80105a41:	0f 84 0e 01 00 00    	je     80105b55 <trap+0x215>
    exit();
}
...
80105a4e:	c3                   	ret    
    ideintr();
80105a4f:	e8 8c c7 ff ff       	call   801021e0 <ideintr>
    lapiceoi();
80105a54:	e8 67 ce ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a59:	e8 02 df ff ff       	call   80103960 <myproc>
80105a5e:	85 c0                	test   %eax,%eax
80105a60:	75 8a                	jne    801059ec <trap+0xac>
80105a62:	eb a5                	jmp    80105a09 <trap+0xc9>
    if(cpuid() == 0){
80105a64:	e8 d7 de ff ff       	call   80103940 <cpuid>
80105a69:	85 c0                	test   %eax,%eax
80105a6b:	75 e7                	jne    80105a54 <trap+0x114>
      acquire(&tickslock);
80105a6d:	83 ec 0c             	sub    $0xc,%esp
80105a70:	68 60 4c 11 80       	push   $0x80114c60
80105a75:	e8 e6 ea ff ff       	call   80104560 <acquire>
      wakeup(&ticks);
80105a7a:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
      ticks++;
80105a81:	83 05 a0 54 11 80 01 	addl   $0x1,0x801154a0
      wakeup(&ticks);
80105a88:	e8 53 e6 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105a8d:	c7 04 24 60 4c 11 80 	movl   $0x80114c60,(%esp)
80105a94:	e8 87 eb ff ff       	call   80104620 <release>
80105a99:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105a9c:	eb b6                	jmp    80105a54 <trap+0x114>
    kbdintr();
80105a9e:	e8 dd cc ff ff       	call   80102780 <kbdintr>
    lapiceoi();
80105aa3:	e8 18 ce ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105aa8:	e8 b3 de ff ff       	call   80103960 <myproc>
80105aad:	85 c0                	test   %eax,%eax
80105aaf:	0f 85 37 ff ff ff    	jne    801059ec <trap+0xac>
80105ab5:	e9 4f ff ff ff       	jmp    80105a09 <trap+0xc9>
    uartintr();
80105aba:	e8 b1 02 00 00       	call   80105d70 <uartintr>
    lapiceoi();
80105abf:	e8 fc cd ff ff       	call   801028c0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ac4:	e8 97 de ff ff       	call   80103960 <myproc>
80105ac9:	85 c0                	test   %eax,%eax
80105acb:	0f 85 1b ff ff ff    	jne    801059ec <trap+0xac>
80105ad1:	e9 33 ff ff ff       	jmp    80105a09 <trap+0xc9>
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105ad6:	8b 7b 38             	mov    0x38(%ebx),%edi
80105ad9:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105add:	e8 5e de ff ff       	call   80103940 <cpuid>
80105ae2:	57                   	push   %edi
80105ae3:	56                   	push   %esi
80105ae4:	50                   	push   %eax
80105ae5:	68 e4 78 10 80       	push   $0x801078e4
80105aea:	e8 c1 ab ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105aef:	e8 cc cd ff ff       	call   801028c0 <lapiceoi>
    break;
80105af4:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105af7:	e8 64 de ff ff       	call   80103960 <myproc>
80105afc:	85 c0                	test   %eax,%eax
80105afe:	0f 85 e8 fe ff ff    	jne    801059ec <trap+0xac>
80105b04:	e9 00 ff ff ff       	jmp    80105a09 <trap+0xc9>
80105b09:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(myproc() && myproc()->state == RUNNING &&
80105b10:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105b14:	0f 85 07 ff ff ff    	jne    80105a21 <trap+0xe1>
    yield();
80105b1a:	e8 b1 e3 ff ff       	call   80103ed0 <yield>
80105b1f:	e9 fd fe ff ff       	jmp    80105a21 <trap+0xe1>
...
80105b32:	0f 85 90 00 00 00    	jne    80105bc8 <trap+0x288>
    myproc()->tf = tf;
80105b38:	e8 23 de ff ff       	call   80103960 <myproc>
80105b3d:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b40:	e8 fb ee ff ff       	call   80104a40 <syscall>
    if(myproc()->killed)
80105b45:	e8 16 de ff ff       	call   80103960 <myproc>
80105b4a:	8b 48 24             	mov    0x24(%eax),%ecx
80105b4d:	85 c9                	test   %ecx,%ecx
80105b4f:	0f 84 f2 fe ff ff    	je     80105a47 <trap+0x107>
}
...
80105b5b:	5d                   	pop    %ebp
      exit();
80105b5c:	e9 2f e2 ff ff       	jmp    80103d90 <exit>
80105b61:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105b68:	0f 20 d6             	mov    %cr2,%esi
    char *mem = kalloc();
80105b6b:	e8 c0 ca ff ff       	call   80102630 <kalloc>
    memset(mem, 0, PGSIZE);
80105b70:	83 ec 04             	sub    $0x4,%esp
    uint va = PGROUNDDOWN(rcr2()); 
80105b73:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
    memset(mem, 0, PGSIZE);
80105b79:	68 00 10 00 00       	push   $0x1000
    char *mem = kalloc();
80105b7e:	89 c3                	mov    %eax,%ebx
    memset(mem, 0, PGSIZE);
80105b80:	6a 00                	push   $0x0
    mappages(myproc()->pgdir, (char*)va, PGSIZE, V2P(mem), PTE_W|PTE_U);
80105b82:	81 c3 00 00 00 80    	add    $0x80000000,%ebx
    memset(mem, 0, PGSIZE);
80105b88:	50                   	push   %eax
80105b89:	e8 e2 ea ff ff       	call   80104670 <memset>
    mappages(myproc()->pgdir, (char*)va, PGSIZE, V2P(mem), PTE_W|PTE_U);
80105b8e:	e8 cd dd ff ff       	call   80103960 <myproc>
80105b93:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80105b9a:	53                   	push   %ebx
80105b9b:	68 00 10 00 00       	push   $0x1000
80105ba0:	56                   	push   %esi
80105ba1:	ff 70 04             	pushl  0x4(%eax)
80105ba4:	e8 17 0e 00 00       	call   801069c0 <mappages>
    return;
80105ba9:	83 c4 20             	add    $0x20,%esp
}
...
80105cf3:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105cf8:	bb 00 7a 10 80       	mov    $0x80107a00,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105d8b:	6a 00                	push   $0x0
  jmp alltraps
80105d8d:	e9 cc fa ff ff       	jmp    8010585e <alltraps>
...
80105d9d:	6a 02                	push   $0x2
  jmp alltraps
80105d9f:	e9 ba fa ff ff       	jmp    8010585e <alltraps>
...
80105dd1:	6a 08                	push   $0x8
  jmp alltraps
80105dd3:	e9 86 fa ff ff       	jmp    8010585e <alltraps>
...
80105dda:	6a 09                	push   $0x9
  jmp alltraps
80105ddc:	e9 7d fa ff ff       	jmp    8010585e <alltraps>
...
80105de1:	6a 0a                	push   $0xa
  jmp alltraps
80105de3:	e9 76 fa ff ff       	jmp    8010585e <alltraps>
...
80105de8:	6a 0b                	push   $0xb
  jmp alltraps
80105dea:	e9 6f fa ff ff       	jmp    8010585e <alltraps>
...
80105df6:	6a 0d                	push   $0xd
  jmp alltraps
80105df8:	e9 61 fa ff ff       	jmp    8010585e <alltraps>
...
80105dfd:	6a 0e                	push   $0xe
  jmp alltraps
80105dff:	e9 5a fa ff ff       	jmp    8010585e <alltraps>
...
80105e06:	6a 0f                	push   $0xf
  jmp alltraps
80105e08:	e9 51 fa ff ff       	jmp    8010585e <alltraps>
...
80105e0f:	6a 10                	push   $0x10
  jmp alltraps
80105e11:	e9 48 fa ff ff       	jmp    8010585e <alltraps>
...
80105e16:	6a 11                	push   $0x11
  jmp alltraps
80105e18:	e9 41 fa ff ff       	jmp    8010585e <alltraps>
...
80105e1f:	6a 12                	push   $0x12
  jmp alltraps
80105e21:	e9 38 fa ff ff       	jmp    8010585e <alltraps>
...
80105e28:	6a 13                	push   $0x13
  jmp alltraps
80105e2a:	e9 2f fa ff ff       	jmp    8010585e <alltraps>
...
80105e31:	6a 14                	push   $0x14
  jmp alltraps
80105e33:	e9 26 fa ff ff       	jmp    8010585e <alltraps>
...
80105e3a:	6a 15                	push   $0x15
  jmp alltraps
80105e3c:	e9 1d fa ff ff       	jmp    8010585e <alltraps>
...
80105e43:	6a 16                	push   $0x16
  jmp alltraps
80105e45:	e9 14 fa ff ff       	jmp    8010585e <alltraps>
...
80105e4c:	6a 17                	push   $0x17
  jmp alltraps
80105e4e:	e9 0b fa ff ff       	jmp    8010585e <alltraps>
...
80105e55:	6a 18                	push   $0x18
  jmp alltraps
80105e57:	e9 02 fa ff ff       	jmp    8010585e <alltraps>
...
80105e5e:	6a 19                	push   $0x19
  jmp alltraps
80105e60:	e9 f9 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e67:	6a 1a                	push   $0x1a
  jmp alltraps
80105e69:	e9 f0 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e70:	6a 1b                	push   $0x1b
  jmp alltraps
80105e72:	e9 e7 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e79:	6a 1c                	push   $0x1c
  jmp alltraps
80105e7b:	e9 de f9 ff ff       	jmp    8010585e <alltraps>
...
80105e82:	6a 1d                	push   $0x1d
  jmp alltraps
80105e84:	e9 d5 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e8b:	6a 1e                	push   $0x1e
  jmp alltraps
80105e8d:	e9 cc f9 ff ff       	jmp    8010585e <alltraps>
...
80105e94:	6a 1f                	push   $0x1f
  jmp alltraps
80105e96:	e9 c3 f9 ff ff       	jmp    8010585e <alltraps>
...
80105e9d:	6a 20                	push   $0x20
  jmp alltraps
80105e9f:	e9 ba f9 ff ff       	jmp    8010585e <alltraps>
...
80105ea6:	6a 21                	push   $0x21
  jmp alltraps
80105ea8:	e9 b1 f9 ff ff       	jmp    8010585e <alltraps>
...
80105eaf:	6a 22                	push   $0x22
  jmp alltraps
80105eb1:	e9 a8 f9 ff ff       	jmp    8010585e <alltraps>
...
80105eb8:	6a 23                	push   $0x23
  jmp alltraps
80105eba:	e9 9f f9 ff ff       	jmp    8010585e <alltraps>
...
80105ec1:	6a 24                	push   $0x24
  jmp alltraps
80105ec3:	e9 96 f9 ff ff       	jmp    8010585e <alltraps>
...
80105eca:	6a 25                	push   $0x25
  jmp alltraps
80105ecc:	e9 8d f9 ff ff       	jmp    8010585e <alltraps>
...
80105ed3:	6a 26                	push   $0x26
  jmp alltraps
80105ed5:	e9 84 f9 ff ff       	jmp    8010585e <alltraps>
...
80105edc:	6a 27                	push   $0x27
  jmp alltraps
80105ede:	e9 7b f9 ff ff       	jmp    8010585e <alltraps>
...
80105ee5:	6a 28                	push   $0x28
  jmp alltraps
80105ee7:	e9 72 f9 ff ff       	jmp    8010585e <alltraps>
...
80105eee:	6a 29                	push   $0x29
  jmp alltraps
80105ef0:	e9 69 f9 ff ff       	jmp    8010585e <alltraps>
...
80105ef7:	6a 2a                	push   $0x2a
  jmp alltraps
80105ef9:	e9 60 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f00:	6a 2b                	push   $0x2b
  jmp alltraps
80105f02:	e9 57 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f09:	6a 2c                	push   $0x2c
  jmp alltraps
80105f0b:	e9 4e f9 ff ff       	jmp    8010585e <alltraps>
...
80105f12:	6a 2d                	push   $0x2d
  jmp alltraps
80105f14:	e9 45 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f1b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f1d:	e9 3c f9 ff ff       	jmp    8010585e <alltraps>
...
80105f24:	6a 2f                	push   $0x2f
  jmp alltraps
80105f26:	e9 33 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f2d:	6a 30                	push   $0x30
  jmp alltraps
80105f2f:	e9 2a f9 ff ff       	jmp    8010585e <alltraps>
...
80105f36:	6a 31                	push   $0x31
  jmp alltraps
80105f38:	e9 21 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f3f:	6a 32                	push   $0x32
  jmp alltraps
80105f41:	e9 18 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f48:	6a 33                	push   $0x33
  jmp alltraps
80105f4a:	e9 0f f9 ff ff       	jmp    8010585e <alltraps>
...
80105f51:	6a 34                	push   $0x34
  jmp alltraps
80105f53:	e9 06 f9 ff ff       	jmp    8010585e <alltraps>
...
80105f5a:	6a 35                	push   $0x35
  jmp alltraps
80105f5c:	e9 fd f8 ff ff       	jmp    8010585e <alltraps>
...
80105f63:	6a 36                	push   $0x36
  jmp alltraps
80105f65:	e9 f4 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f6c:	6a 37                	push   $0x37
  jmp alltraps
80105f6e:	e9 eb f8 ff ff       	jmp    8010585e <alltraps>
...
80105f75:	6a 38                	push   $0x38
  jmp alltraps
80105f77:	e9 e2 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f7e:	6a 39                	push   $0x39
  jmp alltraps
80105f80:	e9 d9 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f87:	6a 3a                	push   $0x3a
  jmp alltraps
80105f89:	e9 d0 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f90:	6a 3b                	push   $0x3b
  jmp alltraps
80105f92:	e9 c7 f8 ff ff       	jmp    8010585e <alltraps>
...
80105f99:	6a 3c                	push   $0x3c
  jmp alltraps
80105f9b:	e9 be f8 ff ff       	jmp    8010585e <alltraps>
...
80105fa2:	6a 3d                	push   $0x3d
  jmp alltraps
80105fa4:	e9 b5 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fab:	6a 3e                	push   $0x3e
  jmp alltraps
80105fad:	e9 ac f8 ff ff       	jmp    8010585e <alltraps>
...
80105fb4:	6a 3f                	push   $0x3f
  jmp alltraps
80105fb6:	e9 a3 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fbd:	6a 40                	push   $0x40
  jmp alltraps
80105fbf:	e9 9a f8 ff ff       	jmp    8010585e <alltraps>
...
80105fc6:	6a 41                	push   $0x41
  jmp alltraps
80105fc8:	e9 91 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fcf:	6a 42                	push   $0x42
  jmp alltraps
80105fd1:	e9 88 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fd8:	6a 43                	push   $0x43
  jmp alltraps
80105fda:	e9 7f f8 ff ff       	jmp    8010585e <alltraps>
...
80105fe1:	6a 44                	push   $0x44
  jmp alltraps
80105fe3:	e9 76 f8 ff ff       	jmp    8010585e <alltraps>
...
80105fea:	6a 45                	push   $0x45
  jmp alltraps
80105fec:	e9 6d f8 ff ff       	jmp    8010585e <alltraps>
...
80105ff3:	6a 46                	push   $0x46
  jmp alltraps
80105ff5:	e9 64 f8 ff ff       	jmp    8010585e <alltraps>
...
80105ffc:	6a 47                	push   $0x47
  jmp alltraps
80105ffe:	e9 5b f8 ff ff       	jmp    8010585e <alltraps>
...
80106005:	6a 48                	push   $0x48
  jmp alltraps
80106007:	e9 52 f8 ff ff       	jmp    8010585e <alltraps>
...
8010600e:	6a 49                	push   $0x49
  jmp alltraps
80106010:	e9 49 f8 ff ff       	jmp    8010585e <alltraps>
...
80106017:	6a 4a                	push   $0x4a
  jmp alltraps
80106019:	e9 40 f8 ff ff       	jmp    8010585e <alltraps>
...
80106020:	6a 4b                	push   $0x4b
  jmp alltraps
80106022:	e9 37 f8 ff ff       	jmp    8010585e <alltraps>
...
80106029:	6a 4c                	push   $0x4c
  jmp alltraps
8010602b:	e9 2e f8 ff ff       	jmp    8010585e <alltraps>
...
80106032:	6a 4d                	push   $0x4d
  jmp alltraps
80106034:	e9 25 f8 ff ff       	jmp    8010585e <alltraps>
...
8010603b:	6a 4e                	push   $0x4e
  jmp alltraps
8010603d:	e9 1c f8 ff ff       	jmp    8010585e <alltraps>
...
80106044:	6a 4f                	push   $0x4f
  jmp alltraps
80106046:	e9 13 f8 ff ff       	jmp    8010585e <alltraps>
...
8010604d:	6a 50                	push   $0x50
  jmp alltraps
8010604f:	e9 0a f8 ff ff       	jmp    8010585e <alltraps>
...
80106056:	6a 51                	push   $0x51
  jmp alltraps
80106058:	e9 01 f8 ff ff       	jmp    8010585e <alltraps>
...
8010605f:	6a 52                	push   $0x52
  jmp alltraps
80106061:	e9 f8 f7 ff ff       	jmp    8010585e <alltraps>
...
80106068:	6a 53                	push   $0x53
  jmp alltraps
8010606a:	e9 ef f7 ff ff       	jmp    8010585e <alltraps>
...
80106071:	6a 54                	push   $0x54
  jmp alltraps
80106073:	e9 e6 f7 ff ff       	jmp    8010585e <alltraps>
...
8010607a:	6a 55                	push   $0x55
  jmp alltraps
8010607c:	e9 dd f7 ff ff       	jmp    8010585e <alltraps>
...
80106083:	6a 56                	push   $0x56
  jmp alltraps
80106085:	e9 d4 f7 ff ff       	jmp    8010585e <alltraps>
...
8010608c:	6a 57                	push   $0x57
  jmp alltraps
8010608e:	e9 cb f7 ff ff       	jmp    8010585e <alltraps>
...
80106095:	6a 58                	push   $0x58
  jmp alltraps
80106097:	e9 c2 f7 ff ff       	jmp    8010585e <alltraps>
...
8010609e:	6a 59                	push   $0x59
  jmp alltraps
801060a0:	e9 b9 f7 ff ff       	jmp    8010585e <alltraps>
...
801060a7:	6a 5a                	push   $0x5a
  jmp alltraps
801060a9:	e9 b0 f7 ff ff       	jmp    8010585e <alltraps>
...
801060b0:	6a 5b                	push   $0x5b
  jmp alltraps
801060b2:	e9 a7 f7 ff ff       	jmp    8010585e <alltraps>
...
801060b9:	6a 5c                	push   $0x5c
  jmp alltraps
801060bb:	e9 9e f7 ff ff       	jmp    8010585e <alltraps>
...
801060c2:	6a 5d                	push   $0x5d
  jmp alltraps
801060c4:	e9 95 f7 ff ff       	jmp    8010585e <alltraps>
...
801060cb:	6a 5e                	push   $0x5e
  jmp alltraps
801060cd:	e9 8c f7 ff ff       	jmp    8010585e <alltraps>
...
801060d4:	6a 5f                	push   $0x5f
  jmp alltraps
801060d6:	e9 83 f7 ff ff       	jmp    8010585e <alltraps>
...
801060dd:	6a 60                	push   $0x60
  jmp alltraps
801060df:	e9 7a f7 ff ff       	jmp    8010585e <alltraps>
...
801060e6:	6a 61                	push   $0x61
  jmp alltraps
801060e8:	e9 71 f7 ff ff       	jmp    8010585e <alltraps>
...
801060ef:	6a 62                	push   $0x62
  jmp alltraps
801060f1:	e9 68 f7 ff ff       	jmp    8010585e <alltraps>
...
801060f8:	6a 63                	push   $0x63
  jmp alltraps
801060fa:	e9 5f f7 ff ff       	jmp    8010585e <alltraps>
...
80106101:	6a 64                	push   $0x64
  jmp alltraps
80106103:	e9 56 f7 ff ff       	jmp    8010585e <alltraps>
...
8010610a:	6a 65                	push   $0x65
  jmp alltraps
8010610c:	e9 4d f7 ff ff       	jmp    8010585e <alltraps>
...
80106113:	6a 66                	push   $0x66
  jmp alltraps
80106115:	e9 44 f7 ff ff       	jmp    8010585e <alltraps>
...
8010611c:	6a 67                	push   $0x67
  jmp alltraps
8010611e:	e9 3b f7 ff ff       	jmp    8010585e <alltraps>
...
80106125:	6a 68                	push   $0x68
  jmp alltraps
80106127:	e9 32 f7 ff ff       	jmp    8010585e <alltraps>
...
8010612e:	6a 69                	push   $0x69
  jmp alltraps
80106130:	e9 29 f7 ff ff       	jmp    8010585e <alltraps>
...
80106137:	6a 6a                	push   $0x6a
  jmp alltraps
80106139:	e9 20 f7 ff ff       	jmp    8010585e <alltraps>
...
80106140:	6a 6b                	push   $0x6b
  jmp alltraps
80106142:	e9 17 f7 ff ff       	jmp    8010585e <alltraps>
...
80106149:	6a 6c                	push   $0x6c
  jmp alltraps
8010614b:	e9 0e f7 ff ff       	jmp    8010585e <alltraps>
...
80106152:	6a 6d                	push   $0x6d
  jmp alltraps
80106154:	e9 05 f7 ff ff       	jmp    8010585e <alltraps>
...
8010615b:	6a 6e                	push   $0x6e
  jmp alltraps
8010615d:	e9 fc f6 ff ff       	jmp    8010585e <alltraps>
...
80106164:	6a 6f                	push   $0x6f
  jmp alltraps
80106166:	e9 f3 f6 ff ff       	jmp    8010585e <alltraps>
...
8010616d:	6a 70                	push   $0x70
  jmp alltraps
8010616f:	e9 ea f6 ff ff       	jmp    8010585e <alltraps>
...
80106176:	6a 71                	push   $0x71
  jmp alltraps
80106178:	e9 e1 f6 ff ff       	jmp    8010585e <alltraps>
...
8010617f:	6a 72                	push   $0x72
  jmp alltraps
80106181:	e9 d8 f6 ff ff       	jmp    8010585e <alltraps>
...
80106188:	6a 73                	push   $0x73
  jmp alltraps
8010618a:	e9 cf f6 ff ff       	jmp    8010585e <alltraps>
...
80106191:	6a 74                	push   $0x74
  jmp alltraps
80106193:	e9 c6 f6 ff ff       	jmp    8010585e <alltraps>
...
8010619a:	6a 75                	push   $0x75
  jmp alltraps
8010619c:	e9 bd f6 ff ff       	jmp    8010585e <alltraps>
...
801061a3:	6a 76                	push   $0x76
  jmp alltraps
801061a5:	e9 b4 f6 ff ff       	jmp    8010585e <alltraps>
...
801061b5:	6a 78                	push   $0x78
  jmp alltraps
801061b7:	e9 a2 f6 ff ff       	jmp    8010585e <alltraps>
...
801061be:	6a 79                	push   $0x79
  jmp alltraps
801061c0:	e9 99 f6 ff ff       	jmp    8010585e <alltraps>
...
801061c7:	6a 7a                	push   $0x7a
  jmp alltraps
801061c9:	e9 90 f6 ff ff       	jmp    8010585e <alltraps>
...
801061d9:	6a 7c                	push   $0x7c
  jmp alltraps
801061db:	e9 7e f6 ff ff       	jmp    8010585e <alltraps>
...
801061e2:	6a 7d                	push   $0x7d
  jmp alltraps
801061e4:	e9 75 f6 ff ff       	jmp    8010585e <alltraps>
...
801061eb:	6a 7e                	push   $0x7e
  jmp alltraps
801061ed:	e9 6c f6 ff ff       	jmp    8010585e <alltraps>
...
801067a9:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ae:	e9 ab f0 ff ff       	jmp    8010585e <alltraps>
...
801067b5:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067ba:	e9 9f f0 ff ff       	jmp    8010585e <alltraps>
...
801067c1:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067c6:	e9 93 f0 ff ff       	jmp    8010585e <alltraps>
...
801067cd:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067d2:	e9 87 f0 ff ff       	jmp    8010585e <alltraps>
...
801067d9:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067de:	e9 7b f0 ff ff       	jmp    8010585e <alltraps>
...
801067e5:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067ea:	e9 6f f0 ff ff       	jmp    8010585e <alltraps>
...
801067f1:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
801067f6:	e9 63 f0 ff ff       	jmp    8010585e <alltraps>
...
80106888:	89 d3                	mov    %edx,%ebx
  ...
  a = PGROUNDUP(newsz);
8010688a:	8d 91 ff 0f 00 00    	lea    0xfff(%ecx),%edx
80106890:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
deallocuvm(pde_t *pgdir, uint oldsz, uint newsz)
80106896:	83 ec 1c             	sub    $0x1c,%esp
80106899:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
8010689c:	39 da                	cmp    %ebx,%edx
8010689e:	73 5b                	jae    801068fb <deallocuvm.part.0+0x7b>
801068a0:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
801068a3:	89 d7                	mov    %edx,%edi
801068a5:	eb 14                	jmp    801068bb <deallocuvm.part.0+0x3b>
801068a7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801068ae:	66 90                	xchg   %ax,%ax
801068b0:	81 c7 00 10 00 00    	add    $0x1000,%edi
801068b6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
801068b9:	76 40                	jbe    801068fb <deallocuvm.part.0+0x7b>
    pte = walkpgdir(pgdir, (char*)a, 0);
801068bb:	31 c9                	xor    %ecx,%ecx
801068bd:	89 fa                	mov    %edi,%edx
801068bf:	89 f0                	mov    %esi,%eax
801068c1:	e8 3a ff ff ff       	call   80106800 <walkpgdir>
801068c6:	89 c3                	mov    %eax,%ebx
    if(!pte)
801068c8:	85 c0                	test   %eax,%eax
801068ca:	74 44                	je     80106910 <deallocuvm.part.0+0x90>
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
    else if((*pte & PTE_P) != 0){
801068cc:	8b 00                	mov    (%eax),%eax
801068ce:	a8 01                	test   $0x1,%al
801068d0:	74 de                	je     801068b0 <deallocuvm.part.0+0x30>
      pa = PTE_ADDR(*pte);
      if(pa == 0)
801068d2:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801068d7:	74 47                	je     80106920 <deallocuvm.part.0+0xa0>
        panic("kfree");
      char *v = P2V(pa);
      kfree(v);
801068d9:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
801068dc:	05 00 00 00 80       	add    $0x80000000,%eax
801068e1:	81 c7 00 10 00 00    	add    $0x1000,%edi
      kfree(v);
801068e7:	50                   	push   %eax
801068e8:	e8 83 bb ff ff       	call   80102470 <kfree>
      *pte = 0;
801068ed:	c7 03 00 00 00 00    	movl   $0x0,(%ebx)
801068f3:	83 c4 10             	add    $0x10,%esp
  for(; a  < oldsz; a += PGSIZE){
801068f6:	39 7d e4             	cmp    %edi,-0x1c(%ebp)
801068f9:	77 c0                	ja     801068bb <deallocuvm.part.0+0x3b>
    }
  }
  return newsz;
}
801068fb:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
80106912:	81 e2 00 00 c0 ff    	and    $0xffc00000,%edx
80106918:	8d ba 00 00 40 00    	lea    0x400000(%edx),%edi
8010691e:	eb 96                	jmp    801068b6 <deallocuvm.part.0+0x36>
        panic("kfree");
80106920:	83 ec 0c             	sub    $0xc,%esp
80106923:	68 c6 73 10 80       	push   $0x801073c6
80106928:	e8 63 9a ff ff       	call   80100390 <panic>
...
80106937:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
8010693a:	e8 01 d0 ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
8010693f:	ba 2f 00 00 00       	mov    $0x2f,%edx
80106944:	69 c0 b0 00 00 00    	imul   $0xb0,%eax,%eax
8010694a:	66 89 55 f2          	mov    %dx,-0xe(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010694e:	c7 80 f8 27 11 80 ff 	movl   $0xffff,-0x7feed808(%eax)
80106955:	ff 00 00 
80106958:	c7 80 fc 27 11 80 00 	movl   $0xcf9a00,-0x7feed804(%eax)
8010695f:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106962:	c7 80 00 28 11 80 ff 	movl   $0xffff,-0x7feed800(%eax)
80106969:	ff 00 00 
8010696c:	c7 80 04 28 11 80 00 	movl   $0xcf9200,-0x7feed7fc(%eax)
80106973:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106976:	c7 80 08 28 11 80 ff 	movl   $0xffff,-0x7feed7f8(%eax)
8010697d:	ff 00 00 
80106980:	c7 80 0c 28 11 80 00 	movl   $0xcffa00,-0x7feed7f4(%eax)
80106987:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
8010698a:	c7 80 10 28 11 80 ff 	movl   $0xffff,-0x7feed7f0(%eax)
80106991:	ff 00 00 
80106994:	c7 80 14 28 11 80 00 	movl   $0xcff200,-0x7feed7ec(%eax)
8010699b:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
8010699e:	05 f0 27 11 80       	add    $0x801127f0,%eax
  pd[1] = (uint)p;
...
801069cd:	8b 45 0c             	mov    0xc(%ebp),%eax
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801069d0:	8b 4d 10             	mov    0x10(%ebp),%ecx
{
801069d3:	8b 7d 08             	mov    0x8(%ebp),%edi
  a = (char*)PGROUNDDOWN((uint)va);
801069d6:	89 c6                	mov    %eax,%esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801069d8:	8d 44 08 ff          	lea    -0x1(%eax,%ecx,1),%eax
801069dc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  a = (char*)PGROUNDDOWN((uint)va);
801069e1:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  last = (char*)PGROUNDDOWN(((uint)va) + size - 1);
801069e7:	89 45 e0             	mov    %eax,-0x20(%ebp)
801069ea:	8b 45 14             	mov    0x14(%ebp),%eax
801069ed:	29 f0                	sub    %esi,%eax
801069ef:	89 45 e4             	mov    %eax,-0x1c(%ebp)
801069f2:	eb 1c                	jmp    80106a10 <mappages+0x50>
801069f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(*pte & PTE_P)
801069f8:	f6 00 01             	testb  $0x1,(%eax)
801069fb:	75 45                	jne    80106a42 <mappages+0x82>
    *pte = pa | perm | PTE_P;
801069fd:	0b 5d 18             	or     0x18(%ebp),%ebx
80106a00:	83 cb 01             	or     $0x1,%ebx
80106a03:	89 18                	mov    %ebx,(%eax)
    if(a == last)
80106a05:	3b 75 e0             	cmp    -0x20(%ebp),%esi
80106a08:	74 2e                	je     80106a38 <mappages+0x78>
    a += PGSIZE;
80106a0a:	81 c6 00 10 00 00    	add    $0x1000,%esi
  for(;;){
80106a10:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80106a13:	b9 01 00 00 00       	mov    $0x1,%ecx
80106a18:	89 f2                	mov    %esi,%edx
80106a1a:	8d 1c 06             	lea    (%esi,%eax,1),%ebx
80106a1d:	89 f8                	mov    %edi,%eax
80106a1f:	e8 dc fd ff ff       	call   80106800 <walkpgdir>
80106a24:	85 c0                	test   %eax,%eax
80106a26:	75 d0                	jne    801069f8 <mappages+0x38>
}
...
80106a45:	68 08 7a 10 80       	push   $0x80107a08
80106a4a:	e8 41 99 ff ff       	call   80100390 <panic>
80106a4f:	90                   	nop
...
80106a54:	a1 a4 54 11 80       	mov    0x801154a4,%eax
...
80106b8d:	8b 75 10             	mov    0x10(%ebp),%esi
80106b90:	8b 55 08             	mov    0x8(%ebp),%edx
80106b93:	8b 7d 0c             	mov    0xc(%ebp),%edi
  if(sz >= PGSIZE)
80106b96:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106b9c:	77 50                	ja     80106bee <inituvm+0x6e>
80106b9e:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  mem = kalloc();
...
80106bb8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
80106bbb:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106bc1:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106bc8:	50                   	push   %eax
80106bc9:	68 00 10 00 00       	push   $0x1000
80106bce:	6a 00                	push   $0x0
80106bd0:	52                   	push   %edx
80106bd1:	e8 ea fd ff ff       	call   801069c0 <mappages>
  memmove(mem, init, sz);
80106bd6:	89 75 10             	mov    %esi,0x10(%ebp)
80106bd9:	83 c4 20             	add    $0x20,%esp
80106bdc:	89 7d 0c             	mov    %edi,0xc(%ebp)
80106bdf:	89 5d 08             	mov    %ebx,0x8(%ebp)
}
...
80106be8:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106be9:	e9 22 db ff ff       	jmp    80104710 <memmove>
    panic("inituvm: more than a page");
80106bee:	83 ec 0c             	sub    $0xc,%esp
80106bf1:	68 4d 7a 10 80       	push   $0x80107a4d
80106bf6:	e8 95 97 ff ff       	call   80100390 <panic>
...
80106cda:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80106cdd:	8b 7d 10             	mov    0x10(%ebp),%edi
80106ce0:	85 ff                	test   %edi,%edi
80106ce2:	0f 88 c0 00 00 00    	js     80106da8 <allocuvm+0xd8>
  if(newsz < oldsz)
80106ce8:	3b 7d 0c             	cmp    0xc(%ebp),%edi
80106ceb:	0f 82 a7 00 00 00    	jb     80106d98 <allocuvm+0xc8>
  a = PGROUNDUP(oldsz);
80106cf1:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cf4:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106cfa:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106d00:	39 75 10             	cmp    %esi,0x10(%ebp)
80106d03:	0f 86 92 00 00 00    	jbe    80106d9b <allocuvm+0xcb>
80106d09:	89 7d e4             	mov    %edi,-0x1c(%ebp)
80106d0c:	8b 7d 08             	mov    0x8(%ebp),%edi
80106d0f:	eb 47                	jmp    80106d58 <allocuvm+0x88>
...
80106d23:	e8 48 d9 ff ff       	call   80104670 <memset>
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
80106d28:	8d 83 00 00 00 80    	lea    -0x80000000(%ebx),%eax
80106d2e:	c7 04 24 06 00 00 00 	movl   $0x6,(%esp)
80106d35:	50                   	push   %eax
80106d36:	68 00 10 00 00       	push   $0x1000
80106d3b:	56                   	push   %esi
80106d3c:	57                   	push   %edi
80106d3d:	e8 7e fc ff ff       	call   801069c0 <mappages>
80106d42:	83 c4 20             	add    $0x20,%esp
80106d45:	85 c0                	test   %eax,%eax
80106d47:	78 6f                	js     80106db8 <allocuvm+0xe8>
  for(; a < newsz; a += PGSIZE){
80106d49:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106d4f:	39 75 10             	cmp    %esi,0x10(%ebp)
80106d52:	0f 86 a0 00 00 00    	jbe    80106df8 <allocuvm+0x128>
    mem = kalloc();
80106d58:	e8 d3 b8 ff ff       	call   80102630 <kalloc>
80106d5d:	89 c3                	mov    %eax,%ebx
    if(mem == 0){
80106d5f:	85 c0                	test   %eax,%eax
80106d61:	75 b5                	jne    80106d18 <allocuvm+0x48>
      cprintf("allocuvm out of memory\n");
80106d63:	83 ec 0c             	sub    $0xc,%esp
80106d66:	68 85 7a 10 80       	push   $0x80107a85
80106d6b:	e8 40 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106d70:	8b 45 0c             	mov    0xc(%ebp),%eax
80106d73:	83 c4 10             	add    $0x10,%esp
80106d76:	39 45 10             	cmp    %eax,0x10(%ebp)
80106d79:	74 2d                	je     80106da8 <allocuvm+0xd8>
80106d7b:	8b 55 10             	mov    0x10(%ebp),%edx
80106d7e:	89 c1                	mov    %eax,%ecx
80106d80:	8b 45 08             	mov    0x8(%ebp),%eax
      return 0;
80106d83:	31 ff                	xor    %edi,%edi
80106d85:	e8 f6 fa ff ff       	call   80106880 <deallocuvm.part.0>
}
...
80106d94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    return oldsz;
80106d98:	8b 7d 0c             	mov    0xc(%ebp),%edi
}
80106d9b:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106d9e:	89 f8                	mov    %edi,%eax
80106da0:	5b                   	pop    %ebx
80106da1:	5e                   	pop    %esi
80106da2:	5f                   	pop    %edi
80106da3:	5d                   	pop    %ebp
...
80106dbb:	68 9d 7a 10 80       	push   $0x80107a9d
...
80106df8:	8b 7d e4             	mov    -0x1c(%ebp),%edi
80106dfb:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106dfe:	5b                   	pop    %ebx
80106dff:	5e                   	pop    %esi
80106e00:	89 f8                	mov    %edi,%eax
80106e02:	5f                   	pop    %edi
80106e03:	5d                   	pop    %ebp
80106e04:	c3                   	ret    
...
80106e24:	5d                   	pop    %ebp
80106e25:	e9 56 fa ff ff       	jmp    80106880 <deallocuvm.part.0>
...
80106e5f:	e8 1c fa ff ff       	call   80106880 <deallocuvm.part.0>
...
80106eac:	68 b9 7a 10 80       	push   $0x80107ab9
...
80106ee4:	e8 87 d7 ff ff       	call   80104670 <memset>
80106ee9:	83 c4 10             	add    $0x10,%esp
                (uint)k->phys_start, k->perm) < 0) {
80106eec:	8b 43 04             	mov    0x4(%ebx),%eax
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start,
80106eef:	8b 53 08             	mov    0x8(%ebx),%edx
80106ef2:	83 ec 0c             	sub    $0xc,%esp
80106ef5:	ff 73 0c             	pushl  0xc(%ebx)
80106ef8:	29 c2                	sub    %eax,%edx
80106efa:	50                   	push   %eax
80106efb:	52                   	push   %edx
80106efc:	ff 33                	pushl  (%ebx)
80106efe:	56                   	push   %esi
80106eff:	e8 bc fa ff ff       	call   801069c0 <mappages>
...
80106f72:	e8 89 f8 ff ff       	call   80106800 <walkpgdir>
  if(pte == 0)
...
80106f83:	68 ca 7a 10 80       	push   $0x80107aca
...
80106fa7:	0f 84 9e 00 00 00    	je     8010704b <copyuvm+0xbb>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106fad:	8b 55 0c             	mov    0xc(%ebp),%edx
80106fb0:	85 d2                	test   %edx,%edx
80106fb2:	0f 84 93 00 00 00    	je     8010704b <copyuvm+0xbb>
80106fb8:	31 f6                	xor    %esi,%esi
80106fba:	eb 44                	jmp    80107000 <copyuvm+0x70>
...
80106fd0:	e8 3b d7 ff ff       	call   80104710 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0) {
80106fd5:	58                   	pop    %eax
80106fd6:	8d 87 00 00 00 80    	lea    -0x80000000(%edi),%eax
80106fdc:	ff 75 e4             	pushl  -0x1c(%ebp)
80106fdf:	50                   	push   %eax
80106fe0:	68 00 10 00 00       	push   $0x1000
80106fe5:	56                   	push   %esi
80106fe6:	ff 75 e0             	pushl  -0x20(%ebp)
80106fe9:	e8 d2 f9 ff ff       	call   801069c0 <mappages>
80106fee:	83 c4 20             	add    $0x20,%esp
80106ff1:	85 c0                	test   %eax,%eax
80106ff3:	78 6b                	js     80107060 <copyuvm+0xd0>
  for(i = 0; i < sz; i += PGSIZE){
80106ff5:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106ffb:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106ffe:	76 4b                	jbe    8010704b <copyuvm+0xbb>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80107000:	8b 45 08             	mov    0x8(%ebp),%eax
80107003:	31 c9                	xor    %ecx,%ecx
80107005:	89 f2                	mov    %esi,%edx
80107007:	e8 f4 f7 ff ff       	call   80106800 <walkpgdir>
8010700c:	85 c0                	test   %eax,%eax
8010700e:	74 6b                	je     8010707b <copyuvm+0xeb>
    if(!(*pte & PTE_P))
80107010:	8b 38                	mov    (%eax),%edi
80107012:	f7 c7 01 00 00 00    	test   $0x1,%edi
80107018:	74 54                	je     8010706e <copyuvm+0xde>
    pa = PTE_ADDR(*pte);
8010701a:	89 fb                	mov    %edi,%ebx
    flags = PTE_FLAGS(*pte);
8010701c:	81 e7 ff 0f 00 00    	and    $0xfff,%edi
80107022:	89 7d e4             	mov    %edi,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
80107025:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
    if((mem = kalloc()) == 0)
8010702b:	e8 00 b6 ff ff       	call   80102630 <kalloc>
80107030:	89 c7                	mov    %eax,%edi
80107032:	85 c0                	test   %eax,%eax
80107034:	75 8a                	jne    80106fc0 <copyuvm+0x30>
    }
  }
  return d;
...
80107039:	ff 75 e0             	pushl  -0x20(%ebp)
8010703c:	e8 ff fd ff ff       	call   80106e40 <freevm>
  return 0;
...
80107064:	e8 07 b4 ff ff       	call   80102470 <kfree>
      goto bad;
80107069:	83 c4 10             	add    $0x10,%esp
8010706c:	eb c8                	jmp    80107036 <copyuvm+0xa6>
      panic("copyuvm: page not present");
8010706e:	83 ec 0c             	sub    $0xc,%esp
80107071:	68 ee 7a 10 80       	push   $0x80107aee
80107076:	e8 15 93 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
8010707b:	83 ec 0c             	sub    $0xc,%esp
8010707e:	68 d4 7a 10 80       	push   $0x80107ad4
...
801070a2:	e8 59 f7 ff ff       	call   80106800 <walkpgdir>
  if((*pte & PTE_P) == 0)
